...
// end included. The UIDs in the range [start, end] can then be used by the client in the mutations
...
// namespaces, end included. The namespaces in the range [start, end] can then be used by the client.
...
func (d *Dgraph) allocateIDs(ctx context.Context, howMany uint64,
	...
	resp, err := doWithRetryLogin(ctx, d, func() (*apiv25.AllocateIDsResponse, error) {
