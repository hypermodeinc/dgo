...
const (
	...
	Dgraph_InitiateSnapShotStream_FullMethodName = "/api.Dgraph/InitiateSnapShotStream"
	Dgraph_StreamPSnapshot_FullMethodName        = "/api.Dgraph/StreamPSnapshot"
)
...
type DgraphClient interface {
	...
	InitiateSnapShotStream(ctx context.Context, in *InitiateSnapShotStreamRequest, opts ...grpc.CallOption) (*SnapShotStreamResponse, error)
	StreamPSnapshot(ctx context.Context, opts ...grpc.CallOption) (Dgraph_StreamPSnapshotClient, error)
}
...
func (c *dgraphClient) InitiateSnapShotStream(ctx context.Context, in *InitiateSnapShotStreamRequest, opts ...grpc.CallOption) (*SnapShotStreamResponse, error) {
	out := new(SnapShotStreamResponse)
	err := c.cc.Invoke(ctx, Dgraph_InitiateSnapShotStream_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dgraphClient) StreamPSnapshot(ctx context.Context, opts ...grpc.CallOption) (Dgraph_StreamPSnapshotClient, error) {
	stream, err := c.cc.NewStream(ctx, &Dgraph_ServiceDesc.Streams[0], Dgraph_StreamPSnapshot_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &dgraphStreamPSnapshotClient{stream}
	return x, nil
}

type Dgraph_StreamPSnapshotClient interface {
	Send(*KVS) error
	CloseAndRecv() (*Ack, error)
	grpc.ClientStream
}

type dgraphStreamPSnapshotClient struct {
	grpc.ClientStream
}

func (x *dgraphStreamPSnapshotClient) Send(m *KVS) error {
	return x.ClientStream.SendMsg(m)
}

func (x *dgraphStreamPSnapshotClient) CloseAndRecv() (*Ack, error) {
...
type DgraphServer interface {
	...
	InitiateSnapShotStream(context.Context, *InitiateSnapShotStreamRequest) (*SnapShotStreamResponse, error)
	StreamPSnapshot(Dgraph_StreamPSnapshotServer) error
...
func (UnimplementedDgraphServer) InitiateSnapShotStream(context.Context, *InitiateSnapShotStreamRequest) (*SnapShotStreamResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitiateSnapShotStream not implemented")
}
func (UnimplementedDgraphServer) StreamPSnapshot(Dgraph_StreamPSnapshotServer) error {
...
func _Dgraph_StreamPSnapshot_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DgraphServer).StreamPSnapshot(&dgraphStreamPSnapshotServer{stream})
}

type Dgraph_StreamPSnapshotServer interface {
	SendAndClose(*Ack) error
	Recv() (*KVS, error)
	grpc.ServerStream
}

type dgraphStreamPSnapshotServer struct {
	grpc.ServerStream
}

func (x *dgraphStreamPSnapshotServer) SendAndClose(m *Ack) error {
	return x.ServerStream.SendMsg(m)
}

func (x *dgraphStreamPSnapshotServer) Recv() (*KVS, error) {
	m := new(KVS)
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _Dgraph_StreamPSnapshot_Handler,
			ClientStreams: true,
		},
	},
	Metadata: "api.proto",
