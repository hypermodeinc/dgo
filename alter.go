...
func (d *Dgraph) DropAllNs(ctx context.Context) error {
	req := &apiv25.AlterRequest{Op: apiv25.AlterOp_DROP_ALL}
	return d.doAlter(ctx, req)
}

func (d *Dgraph) SetSchemaForAllNs(ctx context.Context, schema string) error {
	req := &apiv25.AlterRequest{
		Op:     apiv25.AlterOp_GLOBAL_SCHEMA,
		Schema: schema,
	}
	return d.doAlter(ctx, req)
}
