...
func (d *Dgraph) RunDQL(ctx context.Context, q string, opts ...TxnOption) (*apiv25.RunDQLResponse, error) {
	...
	dc := d.anyClientv25()
	req := &apiv25.RunDQLRequest{Query: q, ReadOnly: to.readOnly, BestEffort: to.bestEffort}
...
func (d *Dgraph) RunDQLWithVars(ctx context.Context, q string,
	...
	dc := d.anyClientv25()
	req := &apiv25.RunDQLRequest{Query: q, Vars: vars, ReadOnly: to.readOnly, BestEffort: to.bestEffort}
	return doWithRetryLogin(ctx, d, func() (*apiv25.RunDQLResponse, error) {
		return dc.RunDQL(d.getContext(ctx), req)
	})
}
